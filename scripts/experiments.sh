...
mkdir ${OUTPUT_DIR}
BUILD_METHOD=suffix_dfa MAX_POINTERS=1 TEMP=0.3 OUTPUT_DIR=${OUTPUT_DIR} source scripts/run.sh
...
OUTPUT_DIR=out/oracle-1-t3
mkdir ${OUTPUT_DIR}
BUILD_METHOD=oracle MAX_POINTERS=1 TEMP=0.3 OUTPUT_DIR=${OUTPUT_DIR} source scripts/run.sh
